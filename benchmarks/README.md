...
- `results/value_proof_benchmarks.json`: poisoned-corpus, mixed-source, and SWE-bench replay results
...
- a `SWE-bench_Lite` replay pilot to test gold-path versus wrong-file proposals
